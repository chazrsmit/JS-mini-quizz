...
//   intro.innerText = `Bienvenue ${prenom}, te voilà dans notre quizz` //mettre cette partie dans la fonction sinon on ne peut pas utiliser prénom
// }
...
intro.innerText = `Bienvenue ${prenom}, te voilà dans notre quizz.`
